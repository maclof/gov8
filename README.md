...
contain 480 normalized checks: 471 compare byte-for-byte with Go and two have
narrowly documented safety normalizations; three heap-snapshot and four
positive Wasm-cache checks await Go conformance coverage.
