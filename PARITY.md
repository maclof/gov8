...
The fixtures under `rust-oracle/tests/fixtures` currently contain 504 normalized
checks. Go matches 483 byte-for-byte and two more after documented safety
normalizations; five deferred-import, six cppgc custom-heap lifecycle, and eight
Fast API residual checks are currently oracle-only. Fatal and panic-boundary
...
On 2026-09-01, the Rust fixtures contain 504 normalized checks. Go compares 483 checks
...
six cppgc custom-heap lifecycle, and eight Fast API residual checks remain oracle-only.
