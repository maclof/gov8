...
normalizations; no executable checks remain oracle-only. Fatal and
...
On 2026-09-01, the Rust fixtures contain 458 normalized checks. Go compares 456 checks
byte-for-byte; the advanced stack line and custom-platform inline-deadlock probe
pass after the two narrow safety normalizations documented above. No executable
