...
normalizations; six cppgc custom-heap lifecycle checks are currently
oracle-only. Fatal and panic-boundary subprocess tests are additional evidence
...
On 2026-09-01, the Rust fixtures contain 491 normalized checks. Go compares 483 checks
...
custom-heap lifecycle checks remain oracle-only. The Rust oracle suites pass formatting,
