...
callbacks (roughly 9x), compiled-Wasm restoration (about 3.5-3.9x), lazy-property
materialization (3.38x), synthetic and cached modules (roughly 2.1-4.0x), small
