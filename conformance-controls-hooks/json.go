...
// encodings this slice uses are included. Floats use Go's shortest
// round-trip plain-decimal formatting, which matches Rust `Display for f64`
// for the values in the documented [1e-4, 1e15) range (no trailing ".0",
