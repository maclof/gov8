...
const FIXTURE: &str = include_str!(
    "fixtures/conformance-inspector-client-callbacks-v8_152.2.0_x86_64-pc-windows-msvc.jsonl"
);
...
fn run_with_deadline() -> Output {
    let mut child = Command::new(env!("CARGO_BIN_EXE_conformance-inspector-client-callbacks"))
        ...
        .spawn()
        .expect("failed to run inspector client-callback oracle");
    ...
    loop {
        ...
        if Instant::now() >= deadline {
            ...
            panic!(
                "inspector client-callback oracle exceeded deadline\nstdout:\n{}\nstderr:\n{}",
...
#[test]
fn inspector_client_callbacks_match_fixture() {
...
#[test]
fn inspector_client_callbacks_are_deterministic_and_ordered() {
