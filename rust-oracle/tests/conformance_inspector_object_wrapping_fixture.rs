...
const FIXTURE: &str = include_str!(
    "fixtures/conformance-inspector-object-wrapping-v8_152.2.0_x86_64-pc-windows-msvc.jsonl"
);
...
fn run_with_deadline() -> Output {
    let mut child = Command::new(env!("CARGO_BIN_EXE_conformance-inspector-object-wrapping"))
        ...
        .spawn()
        .expect("failed to run Inspector object-wrapping oracle");
    ...
    loop {
        ...
        if Instant::now() >= deadline {
            ...
            panic!(
                "Inspector object-wrapping oracle exceeded deadline\nstdout:\n{}\nstderr:\n{}",
...
#[test]
fn inspector_object_wrapping_matches_fixture() {
...
#[test]
fn inspector_object_wrapping_is_deterministic_and_ordered() {
