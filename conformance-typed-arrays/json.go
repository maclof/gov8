...
// Canonical JSON encoder for the conformance-typed-arrays runner.
//
// Normalization rules (must match rust-oracle/src/json.rs and the other
// runners): insertion-ordered objects (duplicate keys preserved — the oracle
// emits them for the interleaved per-kind rows of native_geometry), no
// whitespace, minimal string escaping, plain decimal integers, shortest
// round-trip plain decimal floats.
package main
...
// lowerHex is the canonical encoding for view contents in this slice:
